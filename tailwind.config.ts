...
const config: Config = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      'sm-h2': ['2.75rem', { lineHeight: '120%' }],
      'sm-h3': ['2.063rem', { lineHeight: '120%' }],
      'sm-h4': ['1.563rem', { lineHeight: '120%' }],
      'sm-h5': ['1.188rem', { lineHeight: '120%' }],
      'sm-h6': ['0.875rem', { lineHeight: '110%' }],
      'md-h1': ['4.188rem', { lineHeight: '110%' }],
      'md-h2': ['3.188rem', { lineHeight: '120%' }],
      'md-h3': ['2.313rem', { lineHeight: '120%' }],
      'md-h4': ['1.75rem', { lineHeight: '120%' }],
    },
    borderRadius: {
      full: '9999px',
      xxs: '0.281rem',
